...
% Option to end list all figures + tables, as Evan Riehl requests
%\usepackage{endfloat}
...
\author{Senan Hogan-Hennessy\thanks{
    ...
    This work has been supported by research grants from the Centre for the Study of Inequality and the Industrial Labour Relations School, Cornell University.
    ...
    and
    Evan Riehl.
    I thank seminar participants at EALE Bergen NHH (2024), and Cornell University (2025, 2026) for helpful discussion.
