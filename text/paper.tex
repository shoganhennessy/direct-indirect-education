...
\author{Senan Hogan-Hennessy\thanks{
    ...
    and
    Evan Riehl.
    I thank seminar participants at Cornell University (2023, 2024, 2025), EALE Bergen NHH (2024) for helpful discussion.
    % A companion paper, which expands on the methodological approach for direct and indirect effects in observational research is \href{https://github.com/shoganhennessy/mediation-natural-experiment/blob/main/mediation-natural-experiment-2025.pdf}{available here}.
...
\date{First Draft: 17 August 2024 \\
    This version:
    \today \\ \vspace{0.25cm}
    \textbf{\textit{Job Market Paper, newest version
        \href{https://github.com/shoganhennessy/direct-indirect-education/blob/main/shoganhennessy-jmp-2025.pdf}{available here}.}}
    \vspace{-1.0cm}
}
\rhead{\today}
...
% Declare data + introduce genetic context
\input{sections/02-data.tex}
% Section on (1) first-stage new Mendelian randomisation (2) genetic effects.
\input{sections/03-genetics.tex}
% Direct and Indirect Effects, conceptual framework. (define estimands)
\input{sections/04-directindirect.tex}
% Mediation results (1) selection model approach
...
%\bibliography{sections/07-bibliography-doi.bib}
% Appendix
\newpage
