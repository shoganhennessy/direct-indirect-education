...
\usepackage{multirow}                                                      % Entries in tabular spanning multiple rows.
...
\usepackage{siunitx} \sisetup{round-mode=places, round-precision=2, group-separator={, }, group-minimum-digits=4}        % Formalise use of units and numbers among text
...
\author{Senan Hogan-Hennessy\thanks{
    This work has been supported by research grants from the Centre for the Study of Inequality and the Industrial Labour Relations School, Cornell University, conducted under UK Biobank Project \#335854.
    Thanks to Harry Patrinos for providing the collected literature review estimates (from \citealt{patrinos2025causal}).
    ...
    and
    David Slichter.
    I thank seminar participants at EALE Bergen NHH (2024), Cornell University (2025, 2026), and TGAC (2026) for helpful discussion.
...
% Title
\title{The Direct and Indirect Effects of \\Genetics and Education}
\date{
    \vskip-0.5cm
    First draft: 12 March 2026 \\
    This version: \today \\
    \vspace{0.25cm}
    \textbf{\textit{Working Paper, with newest version
        \href{https://raw.githubusercontent.com/shoganhennessy/direct-indirect-education/main/direct-indirect-education-2026.pdf}{available here}.}}
    \vspace{-1.25cm}
}
\rhead{\today}
\lhead{The Direct and Indirect Effects of Genetics and Education.}
% Begin
\begin{document}
\clearpage
\maketitle
...
% Framework for using random genetic variation.
\input{sections/03-genetics.tex}
% Causal genetic effects
\input{sections/04-genetic-effects.tex}
% Framework for doing a credible mediation analysis in this context
\input{sections/05-direct.tex}
% Mediation results.
\input{sections/06-direct-effects.tex}
%% Conclusion.
\input{sections/07-conclusion.tex}

% Place for the figures, if endfloat-ed.
%\clearpage
