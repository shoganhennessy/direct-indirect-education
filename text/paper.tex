...
\author{Senan Hogan-Hennessy\thanks{
    ...
    and
    Evan Riehl.
    I thank seminar participants at EALE Bergen NHH (2024), and Cornell University (2023, 2024, 2025) for helpful discussion.
...
\date{This version:
    \today \\ \vspace{0.25cm}
    %\textbf{\textit{Job Market Paper, with newest version
