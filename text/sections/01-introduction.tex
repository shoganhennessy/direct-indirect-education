...
\begin{enumerate}
    \item Intro
    \item Data + biological context.  Major subsection on the adjusted randomisation design.
    \item New results of genetic effects.
    \item Conceptual framework for mediation effects.
    \item Results of the structural mediation analysis.
    \item Conclusion.
\end{enumerate}
