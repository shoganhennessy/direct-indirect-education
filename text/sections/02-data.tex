...
This gives \input{sections/tables/ukb-total-count.txt}individuals in the UKB, with non-missing data in relevant variables. 
...
This gives \input{sections/tables/ukb-analysis-count.txt}individuals in the UKB. 
...
If education had no relationship with SNP variants, then we would expect the correlation between the Ed PGI and education years was indistinguishable from zero; it is, however, highly correlated with education years in the UKB analysis sample.
