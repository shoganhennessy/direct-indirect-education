...
\begin{subfigure}[b]{0.25\textwidth}
    ...
    \begin{tikzpicture}
        ...
        \node [above=0.25cm of mother] {Mother};
        \node [above=0.25cm of father] {Father};
        % Draw individual, and their sibling, nodes.
        \node[state] (individual) [below=1cm of mother] {1};
        \node[state] (sibling)    [below=1cm of father] {0};
        \node [below=0.25cm of individual] {Individual};
        \node [below=0.25cm of sibling]    {Sibling};
        ...
        \node[scale=2] [right=0.5cm of abovesibling]{$\Rightarrow$};
    \end{tikzpicture}
\end{subfigure}
\begin{subfigure}[b]{0.25\textwidth}
    \centering
    \begin{tikzpicture}
        ...
        \node [above=0.25cm of mother] {Mother};
        \node [above=0.25cm of father] {Father};
        \node [color=white,below=0.25cm of individual] {Individual};
