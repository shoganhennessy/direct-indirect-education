...
\begin{subfigure}[b]{0.25\textwidth}
    ...
    \begin{tikzpicture}
        ...
        \node [above=0.25cm of mother] {\textcolor{motherColour}{Mother}};
        \node [above=0.25cm of father] {\textcolor{fatherColour}{Father}};
        % Draw individual, and their sibling, nodes.
        \node[state] (individual) [below=1cm of mother] {1};
        \node[state] (sibling)    [below=1cm of father] {1};
        \node [below=0.25cm of individual] {\textcolor{childColour}{Child}};
        \node [below=0.25cm of sibling]    {\textcolor{parentColour}{Sibling}};
        ...
        \node [left=3.5cm of abovesibling]{IBD0:};
    \end{tikzpicture}
\end{subfigure}
\hskip3cm
\begin{subfigure}[b]{0.25\textwidth}
...
\begin{subfigure}[b]{0.25\textwidth}
    ...
    \begin{tikzpicture}
        ...
        % Bridge to the others
        \node[scale=2] [right=1cm of abovesibling]{$\Rightarrow$};
        \node [left=3.5cm of abovesibling]{IBD1:};
    \end{tikzpicture}
\end{subfigure}
\hskip3cm
\begin{subfigure}[b]{0.25\textwidth}
...
\begin{subfigure}[b]{0.25\textwidth}
    ...
    \begin{tikzpicture}
        ...
        % Bridge to the others
        \node[scale=2] [right=1cm of abovesibling]{$\Rightarrow$};
        \node [left=3.5cm of abovesibling]{IBD2:};
    \end{tikzpicture}
\end{subfigure}
\hskip3cm
\begin{subfigure}[b]{0.25\textwidth}
