...
\begin{frame}
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[c]{0.525\textwidth}
            ...
            \begin{itemize}
                \item Tissue (e.g., DNA) samples from 500,000 Britons
...
\begin{frame}
    ...
    \vfill
    \pause
    \textcolor{red}{Bias terms persist}, regardless of how random \textcolor{blue}{Ed PGI, $Z_i$} is, with any selection-on-observables estimand (i.e., identification result).
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}[noframenumbering]
    \frametitle{Direct and Indirect Effects: Selection Bias}
