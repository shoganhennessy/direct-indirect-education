...
\begin{frame}
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[c]{0.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{presentation-files/headlines/times-ukbionk.png}
        \end{subfigure}
        \hfill
    ...
    $\to$ UK Biobank has a subsample of people with genetic data from parents included; public data do not have this.
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}[noframenumbering]
