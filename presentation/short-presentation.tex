...
\begin{frame}[noframenumbering]
    ...
    \pause
    \[ Z_i^\text{\textcolor{ForestGreen}{Child}} = 
    Z_i^\text{\textcolor{MidnightBlue}{Random}}
    + \frac 12 \left( Z^\text{\textcolor{orange}{Mother}}_i +
        Z^\text{\textcolor{blue}{Father}}_i \right) \]
    \[ Y_i = \alpha + \beta Z_i^\text{\textcolor{MidnightBlue}{Random}}
    \neq \alpha + \beta Z_i^\text{\textcolor{ForestGreen}{Child}}
    + \phi^M Z^\text{\textcolor{orange}{Mother}}_i +
    \phi^F Z^\text{\textcolor{blue}{Father}}_i \]
