    ...
    \begin{columns}
        ...
        \begin{figure}
            \begin{tikzpicture}
                ...
                \begin{scope}[scale=0.4, domain=-0.5:10.5, samples=110, rotate=90]
                    ...
                    \foreach \x in {8}{
                        \pause
                        \draw[red, very thick] (\x, {-sin(\x*36) - 10}) -- (\x, {sin(\x*36) - 10});
                    }
                \end{scope}
            \end{tikzpicture}
        \end{figure}
        \column{0.525\textwidth}
            \[ \Pr \big(
                ...
                = \frac 12 \]
            I.e., inheritance prop score is identified.
...
\begin{frame}[noframenumbering]
    ...
    % Put a figure which shows the further apart parents are, then more room to get a random choice.  Normal dist between Min{Z father, Z Mother} and Max{Z father, Z Mother}, with mean at the half-way point.
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \node[text width=0.1cm, color=red] [right=-0.01cm of outcome] {Earnings};
            \path[->] (instrument) edge (treatment);
            \node[color=blue] [left=0.5cm of instrument] {Ed PGI};
            ...
            \path[->, color=orange] (-2.25, 1.5) edge[bend left=40] (-1.5, 0.75);
            \node[text width=2cm, color=orange] at (-2.75, 1.25) {Measure\\calculated};
            % Add in direct effects.
            \pause
            \path[->] (instrument) edge[bend right=45] (outcome);
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \node[color=blue] [left=0.01cm of instrument] {Ed PGI};
            \node[text width=0.1cm, color=red] [right=-0.01cm of outcome] {Earnings};
            ...
            &= \text{\textcolor{orange}{First-stage}} \times
                \underbrace{
                    \Big( \Egiven{Y_i}{Z_i, D_i = 1} - \Egiven{Y_i}{Z_i, D_i = 0} \Big) }_{
                        \text{\textcolor{orange}{$=$ Returns to Education}}}
    \end{align*}
    \vfill
    \pause
...
\begin{frame}
    ...
    \vfill
    \pause
    \textcolor{red}{Bias terms persist}, regardless of how random \textcolor{blue}{$Z_i$} is, and any selection-on-observables estimator (i.e., identification result).
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
    \frametitle{Direct and Indirect Effects: Selection Bias}
...
\begin{frame}[noframenumbering]
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \node[text width=1.5cm, color=blue] [left=0.1cm of instrument] {Ed PGI};
            \node[text width=1.675cm, color=ForestGreen] [above=0.15cm of treatment] (education) {Education};
            \node[text height=0.5cm, color=orange] [above left=-0.3cm and 0.35cm of treatment] {First-stage};
            \node[state,red] (outcome) [right=2cm of treatment] {$Y$};
            \path[->] (treatment) edge (outcome);
            \node[text width=0.1cm, color=red] [right=-0.01cm of outcome] {Earnings};
            \node[text height=0.5cm, color=orange] [above right=-0.3 and 0.4cm of treatment] {Returns};
