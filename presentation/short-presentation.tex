...
\begin{frame}[noframenumbering, plain]
    ...
    the Centre for the Study of Inequality,
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[c]{0.4\textwidth}
            ...
            \begin{enumerate}
                ...
                \item Genetics gives new findings, \textbf{with caveats.}
            \end{enumerate}
        \end{subfigure}
        \hfill
...
\begin{frame}[noframenumbering]
    ...
    \begin{beamercolorbox}{postit}
        \raggedright
        \vspace{0.01cm} \\
        ``The evidence suggests fluid intelligence and self-control partly mediate the relationship between the PGI [genetic measure] and education.
        Genetic effects are economically meaningful, comparable in size to effects of family environment.''
        \hfill
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            %% Label the direct effect
            \path[->,very thick,color=blue] (instrument) edge[bend right=45] (outcome);
            \node[color=MidnightBlue] [below=1cm of treatment] {Direct Genetic Effect};
            \path[->,very thick, color=ForestGreen] (instrument) edge (treatment);
            \node[color=ForestGreen] [above=0.1cm of treatment] (education) {Education};
            \path[->,very thick, color=ForestGreen] (treatment) edge (outcome);
        \end{tikzpicture}
    \end{figure}
    \vspace{-0.25cm}
    \begin{itemize}
        \item Genetic effects could be entirely returns to education
        \item Disputing claims that genetic measures pick up ``fluid intelligence.''
        \item Ratio, direct / indirect, is unclear
    \end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}[noframenumbering]
...
\begin{frame}[noframenumbering]
    ...
    \begin{figure}
        ...
        \end{tikzpicture}
    \end{figure}
    I look at how Ed PGI \textbf{causally affects} labour market earnings, and \textbf{model how much this relationship is because of the education channel.}
    \begin{figure}
        \centering
        \singlespacing
        \vspace{-0.5cm}
...
%-------------------------------------------------------------------------------
\begin{frame}
    \frametitle{Data: UK Biobank}
    This is \textbf{the} dataset that genetics researchers have used for genetics research.
    \vspace{-0.5cm}
    \begin{figure}[h!]
        \centering
        \singlespacing
        \begin{subfigure}[c]{0.45\textwidth}
            \centering
            %\includegraphics[width=\textwidth]{presentation-files/headlines/ukb.png}
        \end{subfigure}
        \hfill
        \begin{subfigure}[c]{0.525\textwidth}
            \textbf{The first ``Biobank''}
            \begin{itemize}
                \item Tissue samples (e.g., DNA) from 500,000 Britons
                \item Large-scale population study started in 2004, to investigate biological $+$ genetic basis of low-frequency diseases
                \item Includes surveys for social outcomes, including education, occupation, etc.
            \end{itemize}
        \end{subfigure}
    \end{figure}
    \vfill
    \textcolor{white}{
    My access has not been processed yet, so I am merely describing the research design for using UK Biobank data. \\
    $\to$ UK Biobank has a $N \approx 30,000$ subsample of people with genetic data from parents included; public data do not have this.}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}[noframenumbering]
    \frametitle{Data: UK Biobank}
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[c]{0.45\textwidth}
            \centering
            %\includegraphics[width=1.1\textwidth]{presentation-files/headlines/times-ukbiobank.png}
        \end{subfigure}
        \hfill
        \begin{subfigure}[c]{0.525\textwidth}
            \textbf{The first ``Biobank''}
...
%-------------------------------------------------------------------------------
\begin{frame}[noframenumbering]
    \frametitle{Data: \sout{UK Biobank} Health \& Retirement Study}
    ...
    \end{figure}
    \vspace{-0.5cm}
    $N \approx 500,000$ household heads with data on labour outcomes, age 50--65.\footnote[frame]{Limited to race $=$ white, for whom Ed PGI is defined.}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}[noframenumbering]
    \frametitle{Data: Health \& Retirement Study (HRS)}
    A representative panel of retirement-age Americans 1990--2021.
    \vspace{-0.5cm}
    ...
    \end{figure}
    \vspace{-0.25cm}
    household heads with data on labour outcomes, age 50--65.\footnote[frame]{Limited to race $=$ white, for whom Ed PGI is defined.}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}[noframenumbering]
    \frametitle{Data: Health \& Retirement Study (HRS)}
...
\begin{frame}
    ...
    \textbf{Question:} Is Ed PGI correlated with demographics?
    \vspace{-0.25cm}
    \begin{figure}
        \centering
        \singlespacing
...
\begin{frame}[noframenumbering]
    \frametitle{Genetic Associations: Independent Assortment}
    Difference in \textcolor{ForestGreen}{Child's} Ed PGI, away from parents, arises from random inheritance $+$ mixing, \textcolor{ForestGreen}{Mendelian Independent Assortment}.
    ...
    \end{figure}
    \vfill
    Gregor Mendel (1886) worked through principles of genetic inheritance 
    ...
    \begin{columns}
        ...
        \column{0.525\textwidth}
            \[ \Pr \big(
                ...
                = \frac 12 \]
            I.e., inheritance prop. score depends only on parents' genetics.
...
\begin{frame}[noframenumbering]
    ...
    \begin{columns}
        ...
        \column{0.525\textwidth}
            ...
            \vspace{0.5cm}
            Propagate this reasoning across all \textcolor{red}{1,271 single-letter gene changes} in the Ed PGI, and both parents:
    \end{columns}
    \[ Z_i^\text{\textcolor{ForestGreen}{Child}}
        - \Egiven{Z_i^\text{\textcolor{ForestGreen}{Child}}}{
            Z^\text{\textcolor{blue}{Father}}_i,
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \caption{Bin Scatter, \textcolor{blue}{Ed PGI}
...
\begin{frame}[noframenumbering]
    ...
    \begin{figure}
        ...
        \makebox[\textwidth][c]{
            %\includegraphics[width=0.8\textwidth]{
                %../text/sections/figures/genescore-edyears-causal.png}
            }
    \end{figure}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}[noframenumbering]
    ...
    \begin{figure}
        ...
        %\makebox[\textwidth][c]{
            %\includegraphics[width=0.8\textwidth]{
                %../text/sections/figures/genescore-earnings-wider.png}}
    \end{figure}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}[noframenumbering]
    ...
    \begin{figure}
        ...
        \makebox[\textwidth][c]{
            %\includegraphics[width=0.8\textwidth]{
                %../text/sections/figures/genescore-earnings-causal.png}
                }
    \end{figure}
\end{frame}
%-------------------------------------------------------------------------------
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \path[->, color=orange] (-3.0, 1.5) edge[bend left=40] (-1.5, 0.75);
            \node[text width=2cm, color=orange] at (-2.75, 1.25) {PGI\\calculated};
            % Add in direct effects.
            \node[state,red] (outcome) [right=2cm of treatment] {$Y$};
            \node[text width=0.1cm, color=red] [right=-0.01cm of outcome] {Earnings};
            \path[->,thick] (instrument) edge[bend right=45] (outcome);
            \node[text height=0.25cm, color=orange] [below=0.35cm of treatment] {Direct Effect};
...
\begin{frame}
    \frametitle{Direct and Indirect Effects}
    Mediation methods are a general-purpose tool to decompose total treatment effect: \textcolor{blue}{Direct Effect} $+$ \textcolor{ForestGreen}{Indirect} effects.
    \vspace{-0.5cm}
    \begin{figure}
        \centering
        \singlespacing
        \begin{tikzpicture}
            ...
            \node[color=orange] [below=0.35cm of treatment] {Direct Effect};
        \end{tikzpicture}
    \end{figure}
    \vspace{-0.5cm}
    \begin{align*}
...
\begin{frame}
    ...
    \end{align*}
    \vfill
    \textcolor{red}{Bias terms persist}, regardless of how random \textcolor{blue}{Ed PGI, $Z_i$} is, with any selection-on-observables estimand (i.e., negative identification result).
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}[noframenumbering]
    \frametitle{Direct and Indirect Effects: Selection Bias}
...
%            \node[text height=0.25cm, color=blue] [below=-0.1cm of treatment] {Direct Effect};
%        \end{tikzpicture}
%    \end{figure}
%    \vspace{-1cm}
%    \begin{figure}
...
%            % Add in direct effects.
%            \path[->,thick] (instrument) edge[bend right=45] (outcome);
%            \node[text height=0.25cm, color=orange] [below=0.4cm of treatment] {Direct Effect};
%        \end{tikzpicture}
%    \end{figure}
%\end{frame}
\end{document}
