...
\begin{frame}
    ...
    \begin{beamercolorbox}{postit}
        ...
        \hfill
        \underline{\textit{A. Smith (1776), The Wealth of Nations, Volume 1 p. 16.}}
        \vspace{0.02cm}
    \end{beamercolorbox}
    \vspace{-0.25cm}
    \pause
    ...
    \begin{enumerate}
        ...
        \begin{figure}
            ...
            \begin{tikzpicture}
                ...
                \path[->, very thick] (instrument) edge (outcome);
...
\begin{frame}[noframenumbering]
    ...
    Write more here about the plan, and perhaps even why it matters.
    \vspace{0.25cm}
    \tableofcontents
\end{frame}
%-------------------------------------------------------------------------------
...
\end{frame}
%-------------------------------------------------------------------------------
\subsection{Data: Health \& Retirement Study}
%-------------------------------------------------------------------------------
\begin{frame}
...
%-------------------------------------------------------------------------------
\begin{frame}[noframenumbering]
    \frametitle{Genetic Associations}
    \vspace{-0.25cm}
    ...
    \begin{columns}
        ...
        \begin{figure}
            ...
            \begin{tikzpicture}
                ...
                \begin{scope}[scale=0.45, domain=-0.5:10.5, samples=110, rotate=90]
                    ...
                    % Draw the phosphate backbone for
                    \draw[gray, thick] plot (\x,{sin(\x*36)});
                    \draw[gray, thick] plot (\x,{-sin(\x*36)});
                    % Draw the base pairs bonds
                    \foreach \x in {0, 1, ..., 10}{
                        \draw[very thick, blue] (\x, {-sin(\x*36)}) -- (\x, {sin(\x*36)});
                    }
                    %% Mother
                    \node[text width=1.0cm, color=orange] at (11.5, 0 + 3 + 0.25) {Mother};
                    % Draw the phosphate backbone for mother
                    \draw[gray, thick] plot (\x, {sin(\x*36) + 3});
                    \draw[gray, thick] plot (\x, {-sin(\x*36) + 3});
                    % Draw the base pairs bonds
                    \foreach \x in {0, 1, ..., 10}{
                        \draw[very thick, orange] (\x, {-sin(\x*36) + 3}) -- (\x, {sin(\x*36) + 3});
                    }
                    %% Bridge to the child's genome
                    \node[text width=2cm, scale=2] at (5, -6) {$\implies$};
                    \node[text width=1.0cm, color=ForestGreen, scale=1] at (11.5, 0 - 6) {Child};
                    % Draw the phosphate backbone for child
                    \draw[gray, thick] plot (\x, {sin(\x*36) - 6});
                    \draw[gray, thick] plot (\x, {-sin(\x*36) - 6});
                    % Draw the base pairs bonds, with mixed colours
                    \draw[very thick, orange]  (1,  {-sin(1 *36)  - 6}) -- (1,  {sin(1 *36)  - 6});
                    \draw[very thick, orange]  (2,  {0            - 6}) -- (2,  {sin(2 *36)  - 6});
                    \draw[very thick, blue]    (2,  {-sin(2 *36)  - 6}) -- (2,  {0           - 6});
                    \draw[very thick, blue]    (3,  {0            - 6}) -- (3,  {sin(3 *36)  - 6});
                    \draw[very thick, orange]  (3,  {-sin(3 *36)  - 6}) -- (3,  {0           - 6});
                    \draw[very thick, blue]    (4,  {-sin(4 *36)  - 6}) -- (4,  {sin(4 *36)  - 6});
                    \draw[very thick, orange]  (6,  {-sin(6 *36)  - 6}) -- (6,  {sin(6 *36)  - 6});
                    \draw[very thick, orange]  (7,  {0            - 6}) -- (7,  {sin(7 *36)  - 6});
                    \draw[very thick, blue]    (7,  {-sin(7 *36)  - 6}) -- (7,  {0           - 6});
                    \draw[very thick, blue]    (8,  {0            - 6}) -- (8,  {sin(8 *36)  - 6});
                    \draw[very thick, orange]  (8,  {-sin(8 *36)  - 6}) -- (8,  {0           - 6});
                    \draw[very thick, blue]    (9,  {-sin(9 *36)  - 6}) -- (9,  {sin(9 *36)  - 6});
                \end{scope}
            \end{tikzpicture}
        \end{figure}
        \column{0.55\textwidth}
            ...
            No, it is inherited from parents.
            ...
            \vspace{1.0cm}
            No data on parents' indices in HRS \\
            $\implies$ \textbf{results here not causal effects.}
    \end{columns}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}[noframenumbering]
...
\begin{frame}[noframenumbering]
    ...
    \begin{columns}
        ...
        \begin{figure}
            \begin{tikzpicture}
                ...
                \begin{scope}[scale=0.4, domain=-0.5:10.5, samples=110, rotate=90]
                    ...
                    \foreach \x in {8}{
                        \draw[blue, thick] (\x, {-sin(\x*36)}) -- (\x, {sin(\x*36)});
                        \draw[red, very thick] (\x, {-sin(\x*36) - 2}) -- (\x, {sin(\x*36) - 2});
                    }
                    %% Bridge to the child's genome
                    ...
                    \foreach \x in {0, 1, ..., 7, 8, 9, 10}{
                        \draw[blue, thick] (\x, {-sin(\x*36) - 8}) -- (\x, {sin(\x*36) - 8});
                        \draw[orange, thick] (\x, {-sin(\x*36) - 10}) -- (\x, {sin(\x*36) - 10});
                    }
                    % Draw the optional mutation at j = 8
                    \foreach \x in {8}{
                        \draw[red, very thick] (\x, {-sin(\x*36) - 8}) -- (\x, {sin(\x*36) - 8});
                    }
                \end{scope}
            \end{tikzpicture}
        \end{figure}
        \column{0.525\textwidth}
            ...
            \[ Z_i^\text{\textcolor{ForestGreen}{Child}}
                - \frac12 \left( Z^\text{\textcolor{orange}{Mother}}_i +
                    Z^\text{\textcolor{blue}{Father}}_i \right) \]
            \[ \longrightarrow \;\; \text{Independently assigned.} \]
    \end{columns}
\end{frame}
...
\begin{frame}[noframenumbering]
    ...
    \begin{columns}
        ...
        \end{figure}
        \column{0.525\textwidth}
            $\implies$ Use the difference from parents as the plausibly random genetic measure.
            \[ Z_i^\text{\textcolor{ForestGreen}{Child}}
                - \frac12 \left( Z^\text{\textcolor{orange}{Mother}}_i +
                    Z^\text{\textcolor{blue}{Father}}_i \right) \]
            \textbf{Identification Remark:} \\
            Equivalent to using deviation from parents as instrument for \textcolor{ForestGreen}{Child}'s Ed PGI \\
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            % Label the nodes with econ examples
            \node[text width=1.5cm, color=blue] [left=0.01cm of instrument] {Ed PGI};
...
\begin{frame}
    ...
    $\to$ Ed PGI computed from only \textbf{data on genes $+$ education}.
    \vspace{-0.35cm}
    \begin{figure}
        \centering
        \singlespacing
        \begin{tikzpicture}
            ...
            \path[->] (instrument) edge (treatment);
            \node[text width=1.5cm, color=blue] [left=0.1cm of instrument] {Ed PGI};
            \node[text width=1.675cm, color=ForestGreen] [above=0.15cm of treatment] (education) {Education};
            \node[text height=0.5cm, color=orange] [above left=-0.3cm and 0.35cm of treatment] {Take-up};
            % Label where Ed PGI is computed
            \path[->, color=orange] (-3, 1.5) edge[bend left=40] (-1.5, 0.75);
            \node[text width=2cm, color=orange] at (-3, 1.25) {Score\\calculated};
            \pause
            %\pause
    ...
    \begin{table}
        ...
        \begin{tabular}{p{0.45\textwidth} | p{0.45\textwidth}}
            \textcolor{orange}{Returns to Education} &
                \textcolor{orange}{Direct Genetic Channel} \\ \hline
            \begin{itemize}
...
\end{frame}
%-------------------------------------------------------------------------------
\subsection{Mediation of Ed PGI Through Education}
%-------------------------------------------------------------------------------
\begin{frame}
    \frametitle{Direct and Indirect Effects}
    Introduce mediation methods.
    General purpose decomposition of along mechanism pathways.

    \hyperlink{mediation-equations}{\beamergotobutton{Equations}}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
    \frametitle{Direct and Indirect Effects}
...
\begin{frame}
    \frametitle{Direct and Indirect Effects}
    Mediation methods assume \textcolor{ForestGreen}{Education, $D_i$,} is randomly assigned (conditional on demographics) for a valid decomposition.
    \begin{itemize}
        \item Major reason why these methods not used in labour/observational research, despite popularity in other fields.
        \item I address this head on, by explicitly modelling selection bias on \textit{unobserved factors} (e.g., what you want to control for \textbf{but can't})
        \item Structural Roy model, selection into \textcolor{ForestGreen}{Education, $D_i$,} based on gains.
    \end{itemize}
    
    \vfill

    Binary choice to \textcolor{ForestGreen}{attend higher education}: 
    \[ \textcolor{ForestGreen}{D_i(Z_i)}
        = \underbrace{\indicator{\text{Educ Gains} \geq \text{Educ Costs}}}_{
            \text{Function of demographics and unobserved factors}} \]
    $\implies$ adjust estimates for unobserved factors via a selection model.

    $\to$ Connects mediation to classic labour selection models, alternative solution to ``assume \textcolor{ForestGreen}{education $D_i$} is conditionally random.''
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
    \frametitle{Direct and Indirect Effects}
    Selection model decomposition:
    \vspace{-0.25cm}
    \begin{figure}
        \centering
        \singlespacing
...
\begin{frame}[noframenumbering]
    \frametitle{Direct and Indirect Effects}
    Total association Ed PGI $\to$ earnings is up to 100\% education channel $\implies$ direct genetic channel $\approx 0 \%$.
    \vspace{-0.5cm}
    \begin{figure}
        \centering
        \singlespacing
        ...
        \begin{tikzpicture}
            ...
            \node[text height=0.25cm, color=orange] [below=0.65cm of treatment] {Direct Effect};
            \node[text height=0.25cm, color=orange] [below=1.25cm of treatment] {$\approx 0\%$};
            \node[text height=0.5cm, color=orange] [above left=-0.3cm and 0.35cm of treatment] {Take-up};
            \node[text height=0.5cm, color=orange] [below left=-0.5cm and 0.5cm of treatment] {$\approx 60\%$};
            \node[text height=0.5cm, color=orange] [above right=-0.3cm and 0.5cm of treatment] {Returns};
            \node[text height=0.5cm, color=orange] [below right=-0.5cm and 0.1cm of treatment] {$\approx 15\%$};
        \end{tikzpicture}
    \end{figure}
...
\begin{frame}
    ...
    The claims that genetic measures (EA score) have direct effects survives the causal analysis.
    $\to$ \textbf{Implication: genetic predetermination}?
    \vspace{-0.25cm}
    \begin{figure}
        \centering
        \makebox[\textwidth][c]{
            \includegraphics[width=0.65\textwidth]{
                ../text/sections/figures/genescore-correlation.png}}
    \end{figure}
    \vspace{-0.5cm}
    EA score negatively correlated with genetic predisposition to e.g., ADHD.

    \textbf{Implication:} education $+$ labour market unwelcome to these factors, and possible EA score picks this up.
    $\to$ \textbf{Institutions are not unchangeable.}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
    ...
    Summary here
    \begin{enumerate}
        \item Studied Ed PGI associations, with education $+$ earnings.
        \item Estimated direct $+$ indirect components of Ed PGI associations.
        \item Adjusting estimates for a (structural) selection-into-treatment setting, showing \textbf{the direct channel is not distinguishable from zero, disagreeing with claims of ``direct genetic effects'' in contemporary research.}
    \end{enumerate}

    Adam Smith quote here.
...
\begin{frame}[noframenumbering]
    ...
    E.g., simultaneous regression (Imai Keele Yamamoto, 2010):\footnote[frame]{
    ...
    \begin{align*}
        ...
        \text{First-stage: }
            \textcolor{ForestGreen}{D_i}
                &=\theta + \pi \textcolor{blue}{Z_i} + \eta_i \\
        ...
        &\textcolor{red}{Y_i \leftarrow \text{ log(Earnings)}} &
            \implies \textcolor{Orange}{\text{Direct }}
            &= \gamma + \delta \E{\textcolor{ForestGreen}{D_i}} \\
        &   &\textcolor{Orange}{\text{Indirect }}
            &= \pi \left( \beta + \delta \E{\textcolor{blue}{Z_i}} \right)
    \end{align*}

    i.e., a regression decomposition of this model: 
    \vspace{-0.25cm}
    \begin{figure}
        \centering
        \singlespacing
